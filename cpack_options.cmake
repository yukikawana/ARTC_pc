...
IF (WIN32)
    ...
    set(CPACK_WIX_XSL "/home/robotics/workspace7/ARTC_PC.1.0/wix.xsl")
    set(CPACK_WIX_LANG "ja-jp")
    set(CPACK_RESOURCE_FILE_LICENSE
        "/home/robotics/workspace7/ARTC_PC.1.0/cmake/License.rtf")
    configure_file(
        "/home/robotics/workspace7/ARTC_PC.1.0/cmake/wix.xsl.in"
        "/home/robotics/workspace7/ARTC_PC.1.0/wix.xsl" @ONLY)
    ...
    #
    #
    set(CPACK_NSIS_MUI_ICON "/home/robotics/workspace7/ARTC_PC.1.0/cmake\\rt_middleware_logo.ico")
    set(CPACK_NSIS_MUI_UNIICON "/home/robotics/workspace7/ARTC_PC.1.0/cmake\\rt_middleware_logo.ico")
    set(CPACK_PACKAGE_ICON "/home/robotics/workspace7/ARTC_PC.1.0/cmake\\rt_middleware_logo.bmp")
    set(CPACK_NSIS_HELP_LINK "http://www.openrtm.org")
    set(CPACK_NSIS_URL_INFO_ABOUT "http://www.openrtm.org")
    set(CPACK_NSIS_MODIFY_PATH ON)
    set(CPACK_PACKAGE_EXECUTABLES artc_pcComp;artc_pcComp)
    if(INSTALL_DOCUMENTATION)
        set(CPACK_NSIS_MENU_LINKS
            "/usr/local/share/doc/artc_pc-1/html/index.html"
            "Component documentation")
    endif(INSTALL_DOCUMENTATION)
    string(REPLACE "/artc_pc" "" install_prefix_root
        "/usr/local")
    file(TO_NATIVE_PATH "${install_prefix_root}" install_prefix_root)
    set(CPACK_NSIS_INSTALL_ROOT "${install_prefix_root}")
    set(CPACK_NSIS_EXTRA_INSTALL_COMMANDS
        "  Rename \"$INSTDIR\\share\\artc_pc-1\\artc_pc-config.cmake\" \"$INSTDIR\\artc_pc-config.cmake\"
  Rename \"$INSTDIR\\share\\artc_pc-1\\artc_pc-config-version.cmake\" \"$INSTDIR\\artc_pc-config-version.cmake\"")
    set(CPACK_NSIS_EXTRA_UNINSTALL_COMMANDS
        "  Delete \"$INSTDIR\\artc_pc-config.cmake\"
  Delete \"$INSTDIR\\artc_pc-config-version.cmake\"")
ENDIF (WIN32)
